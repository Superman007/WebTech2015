...
public class routes {
public static final controllers.ReverseSocket Socket = new controllers.ReverseSocket();
...
public static final controllers.javascript.ReverseSocket Socket = new controllers.javascript.ReverseSocket();
...
public static final controllers.ref.ReverseSocket Socket = new controllers.ref.ReverseSocket();
